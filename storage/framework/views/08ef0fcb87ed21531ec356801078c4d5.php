    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <!-- <div class="col-12" >
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-block" >Back To Admin  Login</a>
                </div> -->
                <p class="login-box-msg">Log in to begin your session</p>
                <?php echo e(session('member_login')); ?>

                <form method="POST" action="<?php echo e(route('member.loginvalidate')); ?>" id="member-login-form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                            name="phone" value="<?php echo e(old('phone')); ?>" autocomplete="phone" autofocus
...
unset($__errorArgs, $__bag); ?>"
                            name="user_id" value="<?php echo e(old('user_id')); ?>" placeholder="Enter User ID" autofocus
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        const validateRoute = "<?php echo e(route('member.memberexist')); ?>";
        const otpResendRoute = "<?php echo e(route('member.resendotp')); ?>";
        const loginRoute = "<?php echo e(route('member.loginvalidate')); ?>";
    ...
    <script src="<?php echo e(asset('custom\member\js\login.js')); ?>"></script>

</body>

</html>
<?php /**PATH C:\Dhaval\Web Development\LARAVEL\testproject2.0\resources\views/app/member/login.blade.php ENDPATH**/ ?>