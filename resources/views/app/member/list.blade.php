...
@section('header-script')
    <meta name="csrf-token" content="{{ csrf_token() }}"Voter Voting Screen>
                ...
                <form action="{{ route('member.store') }}" id="member-form" data-type="add">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <div>
                            ...
                            <div>
                                <input type="checkbox" data-bootstrap-switch="" name="is_active" id="is_active">
                            </div>
                        </div> --}}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('voting.index') }}" class="btn btn-primary float-right nav-link  ml-2">Back</a>
                    @if (auth()->user()->type == '0')
                        <!-- Export Button -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="exportForm" method="POST"
                                            action="{{ route('member.list-export', $resolutionId) }}">
...
@section('footer-script')
    ...
    <script>
        const memberUpdateRoute = "{{ route('member.update') }}";
        const csrf_token = "{{ csrf_token() }}";
        let hideColumn = {!! auth()->user()->type == 0 ? '1' : '0' !!};
