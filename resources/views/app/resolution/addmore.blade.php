<div class="row file-wrapper">
    ...
    <div class="col-3 mb-2">
        <input class="form-control required-section" type="integer" min="1"
            name="resolution[{{ $randomCount }}][min]" placeholder="Minimum checkable" required>
    </div>
    <div class="col-3 mb-2">
        <input class="form-control required-section" type="integer" min="1"
            name="resolution[{{ $randomCount }}][max]" placeholder="Maximum checkable" required>
    </div>
    <div class="col-6">
    ...
    <div class="col-2">
        <button type="button" class="btn btn-danger required-section "
